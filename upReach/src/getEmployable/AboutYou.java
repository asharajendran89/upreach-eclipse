...
public class AboutYou extends genericClass.LaunchApp {
  @Test
  public void aboutyou() throws InterruptedException {
	  //Implicit Wait 
	  driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
	  //Set text to First Name 
/*	 driver.findElement(By.xpath(".//*[@id='msform']/fieldset[1]/div/div/div/div[1]/div/input")).sendKeys("Asha");
	  //Set text to Last Name
	 driver.findElement(By.xpath(".//*[@id='msform']/fieldset[1]/div/div/div/div[2]/div/input")).sendKeys("Rajendran");
	  //Enter University Email 
	  driver.findElement(By.xpath(".//*[@id='university_email']")).sendKeys("asharajendran@university.ac.uk");
	  //Enter Personal Email 
	  driver.findElement(By.xpath(".//*[@id='msform']/fieldset[1]/div/div/div/div[4]/div/input")).sendKeys("asharajendran@gmail.com");
	  //Enter Mobile Number 
	  driver.findElement(By.xpath(".//*[@id='msform']/fieldset[1]/div/div/div/div[5]/div/input")).sendKeys("08412598452"); */
	  Thread.sleep(30000); 
	  //Select date of birth
	  driver.findElement(By.xpath(".//*[@id='dob']")).sendKeys("12/04/2018");
	  //driver.switchTo().frame(0);
	 // driver.findElement(By.xpath(".html/body/div[2]/div/div/div[3]/div[1]/table/tbody/tr[2]/td[7]/a")).click();
	  //Select Gender
/*	  driver.findElement(By.xpath(".//*[@id='msform']/fieldset[1]/div/div/div/div[8]/div/label[3]/input")).click();
	 //Click on Next Page 
